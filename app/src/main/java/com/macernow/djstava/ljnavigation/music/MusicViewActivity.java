...
public class MusicViewActivity extends AppCompatActivity {
    ...
    private ImageView imageView_info, imageView_back;
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.textView_mode:
                        ...
                        if (musicBinder != null) {
                            ...
                            if (currentMode == MODE_ONE_LOOP) {
                                ...
                                Toast.makeText(MusicViewActivity.this, R.string.music_mode_single_loop, Toast.LENGTH_SHORT).show();
                            } else if (currentMode == MODE_ALL_LOOP) {
                                textView_mode.setText(R.string.music_mode_all_loop);
                                Toast.makeText(MusicViewActivity.this, R.string.music_mode_all_loop, Toast.LENGTH_SHORT).show();
                            } else if (currentMode == MODE_RANDOM) {
                                textView_mode.setText(R.string.music_mode_all_random);
                                Toast.makeText(MusicViewActivity.this, R.string.music_mode_all_random, Toast.LENGTH_SHORT).show();
                            } else if (currentMode == MODE_SEQUENCE) {
                                textView_mode.setText(R.string.music_mode_sequence);
                                Toast.makeText(MusicViewActivity.this, R.string.music_mode_sequence, Toast.LENGTH_SHORT).show();
                            }
                        }
                    ...
                    case R.id.imageView_song_info:
                        Intent intent = new Intent(MusicViewActivity.this, SongDetailActivity.class);
    ...
    private void connectToMusicService() {
        Intent intent = new Intent(MusicViewActivity.this, MusicService.class);
    ...
    * */
    class FilesListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (file.isDirectory()) {
                viewHolder.thumbnail.setImageResource(R.drawable.icon_folder);
        ...
        class ThumbnailLoader extends AsyncTask<File, Void, Bitmap> {
            ...
            protected void onPostExecute(Bitmap bitmap) {
                if (imageViewReference != null) {
                    ...
                    if (imageView != null) {
                        if (bitmap == null) {
                            imageView.setImageResource(R.drawable.icon_music_file);
                        }
                        else {
