...
public class NaviCustomActivity extends Activity implements
    ...
    //退出及显示当前位置
    private ImageView imageView_back, imageView_gps;
        ...
        public void onLocationChanged(AMapLocation location) {
            if (location != null && location.getAMapException().getErrorCode() == 0) {
                ...
                if (mAmapAMapNaviView != null) {
                    ...
                    DJLog.d("Re GPS: " + location.getLatitude() + "," + location.getLongitude());
                    mAmap.clear();
                    mAmap.addMarker(new MarkerOptions().position(latLng).icon(BitmapDescriptorFactory.fromResource(R.drawable.location_marker)));
                    mAmap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, 18));
                }

            } else {
                Toast.makeText(NaviCustomActivity.this, "定位出现异常，请检查网络连接.", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        imageView_back = (ImageView) findViewById(R.id.image_exit);
        imageView_gps = (ImageView) findViewById(R.id.image_gps);
    }
    ...
    private void initComponentsListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.image_exit:
                        new AlertDialog.Builder(NaviCustomActivity.this).setMessage(R.string.alertdialog_message)
                    ...
                    case R.id.image_gps:
                        mLocationManger = LocationManagerProxy.getInstance(NaviCustomActivity.this);
        ...
        imageView_gps.setOnClickListener(clickListener);
    }
    ...
    public void onNaviTurnClick() {
        Intent intent = new Intent(NaviCustomActivity.this, SimpleHudActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
        Bundle bundle = new Bundle();
