 ...
 * 实时导航界面
 */
public class SimpleExtendNaviActivity extends Activity implements OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simpleextend_navi);
        //语音播报开始
    ...
    private void initView() {
        ...
        mStartPointTextView = (TextView) findViewById(R.id.extend_start_position_textview);
        mEndPointTextView = (TextView) findViewById(R.id.extend_end_position_textview);

        mStartNaviButton = (Button) findViewById(R.id.extend_start_navi_button);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.extend_start_navi_button:
    ...
    public void onCalculateRouteSuccess() {
        mRouteCalculatorProgressDialog.dismiss();
        Intent intent = new Intent(SimpleExtendNaviActivity.this,
                NaviExtendActivity.class);
