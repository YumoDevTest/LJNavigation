...
public class EndPointHistoryActivity extends AppCompatActivity {
    private static final int ACTIVITY_NAVI_END_CODE = 5;
    private static final int ACTIVITY_END_POINT_INPUT_CODE = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_end_point_history);
    ...
    private void initUIComponent() {
        imageView = (ImageView) findViewById(R.id.end_point_history_back);
        editText = (EditText) findViewById(R.id.end_point_history_edit);
        editText.setInputType(InputType.TYPE_NULL);
        listView = (ListView) findViewById(R.id.end_point_history_listview);
    ...
    private void initUIComponentListener() {
        onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.end_point_history_back:
                        Intent intent = new Intent();
                        intent.putExtra("end_point_history_string", editText.getText().toString());
                        intent.putExtra("end_point_history_lat", lat);
                        intent.putExtra("end_point_history_lng", lng);
                        setResult(ACTIVITY_NAVI_END_CODE, intent);

                        finish();
                        break;

                    case R.id.end_point_history_edit:
                        startActivityForResult(new Intent(EndPointHistoryActivity.this, EndPointInputActivity.class), ACTIVITY_END_POINT_INPUT_CODE);
                        break;

                    case R.id.button_clear:
                        new AlertDialog.Builder(EndPointHistoryActivity.this).setMessage(R.string.alertdialog_message_clear)
    ...
    private void loadHistory() {
        ...
        sqliteDataBaseHelper = new SqliteDataBaseHelper(EndPointHistoryActivity.this, DATABASE_NAME);
        ...
        try {
            ...
            adapterTextview = new AdapterTextview(EndPointHistoryActivity.this, addressArray);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        //
        switch (resultCode) {
            case ACTIVITY_END_POINT_INPUT_CODE:
                String end_point_string = data.getStringExtra("end_point_edittext_string");
                lat = data.getDoubleExtra("end_point_edittext_lat", 0);
                lng = data.getDoubleExtra("end_point_edittext_lng", 0);

                if (!end_point_string.isEmpty()) {
                    editText.setText(end_point_string);
                    button_clear.setVisibility(View.VISIBLE);
                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_end_point_history, menu);
        return true;
    }
