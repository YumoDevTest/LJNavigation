...
public class WayPointInputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_way_point_input);
    ...
    private void initUIComponent() {
        imageView_back = (ImageView) findViewById(R.id.way_point_back);
        editText = (EditText) findViewById(R.id.way_point_edit);
        listView = (ListView) findViewById(R.id.way_point_listview);
        button = (Button) findViewById(R.id.way_point_button);

        sqliteDataBaseHelper = new SqliteDataBaseHelper(WayPointInputActivity.this,DATABASE_NAME);
    ...
    private void initUIComponentListener() {
        onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.way_point_back:
                        /*
                        * 将输入框的值进行回传
                        * */
                        if ((!editText.getText().toString().isEmpty()) && (latLng != null)){
                            Intent intent = new Intent();
                            intent.putExtra("way_point_edittext_string", editText.getText().toString());
                            intent.putExtra("way_point_edittext_lat",latLng.getLatitude());
                            intent.putExtra("way_point_edittext_lng",latLng.getLongitude());
                    ...
                    case R.id.way_point_edit:
                        editText.addTextChangedListener(new TextWatcher() {
                            ...
                            public void onTextChanged(CharSequence s, int start, int before, int count) {
                                ...
                                query.setPageNum(1);
                                PoiSearch poiSearch = new PoiSearch(WayPointInputActivity.this, query);
                                poiSearch.setOnPoiSearchListener(new PoiSearch.OnPoiSearchListener() {
                                    ...
                                    public void onPoiSearched(PoiResult poiResult, int i) {
                                        if (i == 0) {
                                            ...
                                            adapterTextview_start_poi_result = new AdapterTextview(WayPointInputActivity.this, startPoiAddressArray);
